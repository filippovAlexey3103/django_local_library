...
# Тестирование view LoanedBookInstancesByUserListView
import datetime
...
# Тестирование view with form renew_book_librarian
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_access_denied_if_logged_in_but_not_correct_permission(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('author_create'))
    ...
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        date_of_death = datetime.datetime.strptime('12/10/2016', '%d/%m/%Y')
        self.assertEqual(resp.context['form'].initial['date_of_death'], date_of_death )
    ...
    def test_redirects_to_all_authors_list_on_success(self):
        ...
        resp = self.client.post(reverse('author_create'), {'first_name':'Сергей', 'last_name':'Минаев',} )
